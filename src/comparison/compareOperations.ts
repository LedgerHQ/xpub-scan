 ...
 */
const areMatching = (importedOperation: Operation, actualOperation: Operation) : boolean => {
 ...
 * @returns void
 */
const showOperations = (status: ComparisonStatus, A: Operation, B?: Operation) : void => {
 ...
 */
const checkImportedOperations = (importedOperations: Operation[], actualOperations: Operation[]) : Comparison[] => {
    if (!configuration.silent) {
